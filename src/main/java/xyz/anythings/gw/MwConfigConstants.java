...
public class MwConfigConstants extends LogisConfigConstants {
	 ...
	 * 표시기 점등 전 표시 문자
	 */
	public static final String IND_SHOW_CHARS_BEFORE_ON = "ind.action.show.chars.before.on";
	/**
	 * 표시기 점등 전 문자 표시 시간
	 */
	public static final String IND_SHOW_CHARS_DELAY_BEFORE_ON = "ind.action.show.chars.delay.before.on";
	/**
	 * 표시기 점등 전 딜레이 (100ms)
	 */
	 ...
	 * 표시기 버튼 사용여부
	 */
	public static final String IND_MPI_BUTTONS_ENABLE = "ind.buttons.enable";
	/**
	 * 표시기 최신 버전 정보 설정.
	 */
	 ...
	 * Gateway 최신 버전 정보 설정.
	 */
	public static final String GW_LATEST_RELEASE_VERSION = "ind.gateway.latest.release.version";
	/**
