...
//		Gateway gateway = AnyEntityUtil.findEntityBy(domainId, true, Gateway.class, "gwNm", gwNm);
...
//		Gateway gateway = AnyEntityUtil.findEntityBy(batch.getDomainId(), true, Gateway.class, "gwNm", gwNm);
...
//		Gateway gateway = AnyEntityUtil.findEntityBy(domain.getId(), true, Gateway.class, "gwNm", gwNm);
...
//	 * @param batch
//	 */
//	public void respondGatewayBoot(Gateway gateway) {
//		// 1. domainId
...
//		// Gateway 정보 조회
//		Gateway gateway = AnyEntityUtil.findEntityByCode(domain.getId(), true, Gateway.class, "gwNm", gwNm);
//		
//		if(gateway != null) {
...
//		List<String> rackCdList = AnyEntityUtil.searchItems(domainId, false, String.class, sql, "domainId,gwCd,equipType", domainId, gateway.getGwCd(), "Rack");
//		
//		// 2. 호기로 부터 현재 작업 중인 배치 추출 
//		for(String rackCd : rackCdList) {
//			// 2-1. 호기 체크
//			Rack rack = AnyEntityUtil.findEntityByCode(domainId, true, Rack.class, "rackCd", rackCd);
//			
...
//		Indicator indicator = AnyEntityUtil.findEntityByCode(domain.getId(), true, Indicator.class, "indCd", indCd);
//		
